...
# GuiRectangle inherits from Rectangle and that means GuiRectangle will have all the attributes of Rectangle
# point1, point2, area
# GuiRectangle is a class that has these two methods (__init__, area) + draw method
...
# https://cdn-images-1.medium.com/max/1000/1*MQZZBi6xvEG7lIKzTLkedQ.png
